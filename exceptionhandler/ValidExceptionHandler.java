...
public class ValidExceptionHandler {
  ...
  // 요청 파라미터 바인딩 실패 (@ModelAttribute, @RequestParam)
  ...
  public ResponseEntity<Object> handleBindException(BindException exception) {
    ...
    return ResponseEntity
        .status(HttpStatus.BAD_REQUEST)
        .body(ApiResponse.ERROR(ResErrorCode.BAD_REQUEST, "Binding failed", errors));
  }
  ...
  public ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException exception) {
    ...
    return ResponseEntity
        .status(HttpStatus.BAD_REQUEST)
        .body(ApiResponse.ERROR(ResErrorCode.BAD_REQUEST, "Malformed JSON request", null));
  }
